...
3. Set the ``PeerToPeerLending`` contract newly published address in the [client-app/public/js/contract_interaction.js LINE:3](https://github.com/lokeshjoshi053/DeFiBorrowHub/blob/main/Main%20App/public/js/contract_interaction.js) 
